...
const MainPage = () => {
  ...
  const kill = async(e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("https://classic-hospitality-mothers-bird.trycloudflare.com/api/points/kill", {
        method: 'POST',
        headers: {
  ...
  const solve = async(e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("https://classic-hospitality-mothers-bird.trycloudflare.com/api/points/solve", {
        method: 'POST',
        headers: {
          'Content-type': 'application/json',
        },
  ...
  useEffect(() => {
    ...
    // Get all users
    fetch("https://classic-hospitality-mothers-bird.trycloudflare.com/api/users") // 🔁 change to your API URL
      .then((res) => res.json())
      .then((data) => {
